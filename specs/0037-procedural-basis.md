...
which the doctor reports as UNSTAMPED rather than guessing them into either
bucket. The stamp is immutable on a same-id replace and inherited across a
...
- Migration: NONE. The relation registry is code, not schema; `basis` and
  ...
  producer — written before the stamp; the two cannot be told apart there and
  the doctor says so) and `procedural_shaped`, never added.
...
corpus sha256: 5f06e4bec4e488a4a0b5f9b82972c945af44577d08c69daa3ef9dfb78d5ce8f7
