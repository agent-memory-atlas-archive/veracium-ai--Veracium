...
OVERRIDE = {  # (module, line) -> reason class, where the module default is not the truth for that line
    ...
    ("portability.py", 506): "control-flow",
    ...
    ("store/sqlite.py", 180): "control-flow", ("store/sqlite.py", 255): "control-flow", ("store/sqlite.py", 308): "control-flow",
    ("store/sqlite.py", 377): "control-flow", ("store/sqlite.py", 459): "control-flow", ("store/sqlite.py", 718): "control-flow",
    ("store/sqlite.py", 737): "control-flow", ("store/sqlite.py", 781): "control-flow", ("store/sqlite.py", 846): "control-flow",
    ("store/sqlite.py", 862): "predicate-helper", ("store/sqlite.py", 1017): "control-flow", ("store/sqlite.py", 2070): "control-flow",
    ("store/sqlite.py", 2097): "control-flow", ("store/sqlite.py", 2106): "predicate-helper", ("store/sqlite.py", 162): "argument-check",
    ("store/sqlite.py", 356): "argument-check", ("store/sqlite.py", 2168): "argument-check", ("store/sqlite.py", 2712): "argument-check",
    ("store/sqlite.py", 2727): "argument-check", ("store/sqlite.py", 351): "control-flow", ("store/sqlite.py", 730): "control-flow",
    ("store/sqlite.py", 1297): "control-flow", ("store/sqlite.py", 1573): "control-flow", ("store/sqlite.py", 1585): "control-flow",
    ("store/sqlite.py", 1600): "control-flow", ("store/sqlite.py", 2380): "control-flow", ("store/sqlite.py", 2402): "control-flow",
    ("store/sqlite.py", 2730): "control-flow", ("store/sqlite.py", 2145): "argument-check",
...
e("portability.py", 776, "portability.import.agreement-invalid", "0025", "§4c", "refuse")
...
e("portability.py", 343, "portability.import.file", "0005", "§4", "refuse")
e("portability.py", 346, "portability.import.file", "0005", "§4", "refuse")
e("portability.py", 349, "portability.import.file", "0005", "§4", "refuse")
e("portability.py", 366, "portability.import.file", "0005", "§4", "refuse")
e("portability.py", 379, "portability.import.file", "0005", "§4", "refuse")
e("portability.py", 386, "portability.import.file", "0005", "§4", "refuse")
e("portability.py", 394, "portability.import.file", "0005", "§4", "refuse")
e("portability.py", 402, "portability.import.file", "0005", "§4", "refuse")
e("portability.py", 859, "portability.import.origin-missing", "0006", "§4", "refuse")
e("portability.py", 1104, "portability.import.preflight", "0009", "§4c", "refuse")
e("portability.py", 1115, "portability.import.preflight", "0009", "§4c", "refuse")
e("portability.py", 1126, "portability.import.preflight", "0009", "§4c", "refuse")
e("portability.py", 1140, "portability.import.preflight", "0009", "§4c", "refuse")
e("portability.py", 1146, "portability.import.preflight", "0009", "§4c", "refuse")
e("portability.py", 1168, "portability.import.preflight", "0009", "§4c", "refuse")
e("portability.py", 1177, "portability.import.preflight", "0009", "§4c", "refuse")
e("portability.py", 1196, "portability.import.preflight", "0009", "§4c", "refuse")
e("portability.py", 1062, "portability.import.race-exhausted", "0009", "§4c", "refuse")
e("portability.py", 914, "portability.import.record", "0009", "§4c/0014 §2c", "refuse")
e("portability.py", 925, "portability.import.record", "0009", "§4c/0014 §2c", "refuse")
e("portability.py", 932, "portability.import.record", "0009", "§4c/0014 §2c", "refuse")
e("portability.py", 941, "portability.import.record", "0009", "§4c/0014 §2c", "refuse")
e("portability.py", 958, "portability.import.record", "0009", "§4c/0014 §2c", "refuse")
e("portability.py", 964, "portability.import.record", "0009", "§4c/0014 §2c", "refuse")
e("portability.py", 968, "portability.import.record", "0009", "§4c/0014 §2c", "refuse")
e("portability.py", 976, "portability.import.record", "0009", "§4c/0014 §2c", "refuse")
e("portability.py", 1005, "portability.import.record", "0009", "§4c/0014 §2c", "refuse")
e("portability.py", 1027, "portability.import.record", "0009", "§4c/0014 §2c", "refuse")
e("portability.py", 332, "portability.import.restore-not-bool", "0005", "P13", "refuse")
e("portability.py", 336, "portability.import.restore-with-user", "0005", "P5", "refuse")
...
e("store/sqlite.py", 1638, "store.add-episode", "0009/0010", "X21", "refuse")
e("store/sqlite.py", 1650, "store.add-episode", "0009/0010", "X21", "refuse")
e("store/sqlite.py", 1658, "store.add-episode", "0009/0010", "X21", "refuse")
e("store/sqlite.py", 1665, "store.add-episode", "0009/0010", "X21", "refuse")
e("store/sqlite.py", 1673, "store.add-episode", "0009/0010", "X21", "refuse")
e("store/sqlite.py", 709, "store.confirm.correlation", "0008", "C9", "refuse")
e("store/sqlite.py", 642, "store.confirm.not-assertable", "0008", "§6d", "refuse")
e("store/sqlite.py", 655, "store.confirm.request-digest", "0008", "C9", "refuse")
e("store/sqlite.py", 637, "store.confirm.unknown-edge", "0008", "§6d", "refuse")
e("store/sqlite.py", 1490, "store.consolidation-contribution", "0014", "§2c", "refuse")
e("store/sqlite.py", 1498, "store.consolidation-contribution", "0014", "§2c", "refuse")
e("store/sqlite.py", 1531, "store.consolidation-contribution", "0014", "§2c", "refuse")
e("store/sqlite.py", 2373, "store.consolidation.abandon-live-lease", "0010", "X7", "refuse")
e("store/sqlite.py", 2186, "store.consolidation.contended", "0010", "X7/X11", "refuse")
e("store/sqlite.py", 2358, "store.consolidation.delete-not-current", "0010", "X21", "refuse")
e("store/sqlite.py", 2218, "store.consolidation.renew-refused", "0010", "X7", "refuse")
e("store/sqlite.py", 2313, "store.consolidation.transition", "0010", "§4b", "refuse")
e("store/sqlite.py", 2318, "store.consolidation.transition", "0010", "§4b", "refuse")
e("store/sqlite.py", 2323, "store.consolidation.transition", "0010", "§4b", "refuse")
e("store/sqlite.py", 2329, "store.consolidation.transition", "0010", "§4b", "refuse")
e("store/sqlite.py", 2338, "store.consolidation.transition", "0010", "§4b", "refuse")
e("store/sqlite.py", 2345, "store.consolidation.transition", "0010", "§4b", "refuse")
e("store/sqlite.py", 2348, "store.consolidation.transition", "0010", "§4b", "refuse")
e("store/sqlite.py", 2232, "store.consolidation.write-not-current", "0010", "X23", "refuse")
e("store/sqlite.py", 1313, "store.contribution", "0014", "§4b", "refuse")
e("store/sqlite.py", 1317, "store.contribution", "0014", "§4b", "refuse")
e("store/sqlite.py", 1323, "store.contribution", "0014", "§4b", "refuse")
e("store/sqlite.py", 1328, "store.contribution", "0014", "§4b", "refuse")
e("store/sqlite.py", 1137, "store.correction.authorisation", "0011", "§4b", "refuse")
e("store/sqlite.py", 1144, "store.correction.authorisation", "0011", "§4b", "refuse")
e("store/sqlite.py", 1148, "store.correction.authorisation", "0011", "§4b", "refuse")
e("store/sqlite.py", 1152, "store.correction.authorisation", "0011", "§4b", "refuse")
e("store/sqlite.py", 1156, "store.correction.authorisation", "0011", "§4b", "refuse")
e("store/sqlite.py", 1162, "store.correction.authorisation", "0011", "§4b", "refuse")
e("store/sqlite.py", 1167, "store.correction.authorisation", "0011", "§4b", "refuse")
e("store/sqlite.py", 1171, "store.correction.authorisation", "0011", "§4b", "refuse")
e("store/sqlite.py", 1733, "store.delete-episode.outcome", "0009", "§4c", "refuse")
e("store/sqlite.py", 1741, "store.delete-episode.reserved", "0010", "X21", "refuse")
e("store/sqlite.py", 895, "store.edges.read-fence", "0001", "§4", "withhold")
e("store/sqlite.py", 2778, "store.embedding.delayed-writer", "0027", "§4f", "refuse")
e("store/sqlite.py", 2785, "store.embedding.stale-content", "0027", "§4f", "refuse")
e("store/sqlite.py", 2756, "store.embedding.txn-locked", "0041", "§4e (0007 §4c form)", "refuse")
e("store/sqlite.py", 1630, "store.episode.attested-redaction", "0041", "§4b-ii INV-11", "refuse")
e("store/sqlite.py", 1623, "store.episode.kind-not-recognised", "0041", "§2d-iv/§4h(ii) write path", "refuse")
e("store/sqlite.py", 1618, "store.episode.marker-introduced", "0041", "§4b INV-11's mirror", "refuse")
e("store/sqlite.py", 2391, "store.export.non-quiescent", "0010", "X-quiesce", "refuse")
e("store/sqlite.py", 1408, "store.flattening", "0021", "§4a", "refuse")
e("store/sqlite.py", 1417, "store.flattening", "0021", "§4a", "refuse")
e("store/sqlite.py", 1426, "store.flattening", "0021", "§4a", "refuse")
e("store/sqlite.py", 1431, "store.flattening", "0021", "§4a", "refuse")
e("store/sqlite.py", 1454, "store.flattening", "0021", "§4a", "refuse")
e("store/sqlite.py", 1846, "store.import-plan", "0009", "§4c", "refuse")
e("store/sqlite.py", 1851, "store.import-plan", "0009", "§4c", "refuse")
e("store/sqlite.py", 1855, "store.import-plan", "0009", "§4c", "refuse")
e("store/sqlite.py", 1861, "store.import-plan", "0009", "§4c", "refuse")
e("store/sqlite.py", 1868, "store.import-plan", "0009", "§4c", "refuse")
e("store/sqlite.py", 1875, "store.import-plan", "0009", "§4c", "refuse")
e("store/sqlite.py", 1890, "store.import-plan", "0009", "§4c", "refuse")
e("store/sqlite.py", 1893, "store.import-plan", "0009", "§4c", "refuse")
e("store/sqlite.py", 1896, "store.import-plan", "0009", "§4c", "refuse")
e("store/sqlite.py", 1899, "store.import-plan", "0009", "§4c", "refuse")
e("store/sqlite.py", 1903, "store.import-plan", "0009", "§4c", "refuse")
e("store/sqlite.py", 1907, "store.import-plan", "0009", "§4c", "refuse")
e("store/sqlite.py", 1952, "store.import-plan", "0009", "§4c", "refuse")
e("store/sqlite.py", 1983, "store.import.attested-redaction", "0041", "§4b-ii INV-11 at the import boundary (§4g)", "refuse")
e("store/sqlite.py", 2009, "store.import.attested-redaction", "0041", "§4b-ii INV-11 at the import boundary (§4g)", "refuse")
e("store/sqlite.py", 2003, "store.import.episode-kind-not-recognised", "0041", "§2d-iv/§4h(ii) import boundary", "refuse")
e("store/sqlite.py", 369, "store.journal.pre-epoch", "0029", "§4a", "refuse")
e("store/sqlite.py", 314, "store.journal.reason-not-dispositioned", "0030", "V-TOTAL", "refuse")
e("store/sqlite.py", 322, "store.journal.redaction-reason", "0041", "§4c/§11.2 D1", "refuse")
...
e("store/sqlite.py", 1787, "store.outcome.context-ref", "0009", "§4c", "refuse")
e("store/sqlite.py", 1720, "store.read.input-claimed", "0010", "§4b", "withhold")
e("store/sqlite.py", 1717, "store.read.output-not-visible", "0010", "§4b", "withhold")
e("store/sqlite.py", 2583, "store.redact.disposition-changed", "0041", "§4h(i)", "refuse")
e("store/sqlite.py", 2540, "store.redact.input-claimed", "0041/0010", "X21", "refuse")
e("store/sqlite.py", 2521, "store.redact.reason-not-registered", "0041", "§11.2", "refuse")
e("store/sqlite.py", 2517, "store.redact.target", "0041", "§4a/INV-5", "refuse")
e("store/sqlite.py", 2532, "store.redact.target", "0041", "§4a/INV-5", "refuse")
...
e("store/sqlite.py", 1071, "store.supersession.integrity", "0014", "§4b", "refuse")
e("store/sqlite.py", 1089, "store.supersession.integrity", "0014", "§4b", "refuse")
e("store/sqlite.py", 1105, "store.supersession.integrity", "0014", "§4b", "refuse")
e("store/sqlite.py", 1110, "store.supersession.integrity", "0014", "§4b", "refuse")
e("store/sqlite.py", 1188, "store.supersession.plan", "0014/0019", "§4b", "refuse")
e("store/sqlite.py", 1210, "store.supersession.plan", "0014/0019", "§4b", "refuse")
e("store/sqlite.py", 1218, "store.supersession.plan", "0014/0019", "§4b", "refuse")
e("store/sqlite.py", 1237, "store.supersession.plan", "0014/0019", "§4b", "refuse")
e("store/sqlite.py", 1242, "store.supersession.plan", "0014/0019", "§4b", "refuse")
e("store/sqlite.py", 246, "store.txn.locked", "0013", "§5b", "refuse")
e("store/sqlite.py", 271, "store.txn.locked-retry", "0013", "§5b", "refuse")
e("store/sqlite.py", 507, "store.upsert.attested-redaction", "0041", "§4b-ii INV-11", "refuse")
e("store/sqlite.py", 529, "store.upsert.immutable", "0008/0019/0037", "§6d/V-IMMUTABLE", "refuse")
e("store/sqlite.py", 535, "store.upsert.immutable", "0008/0019/0037", "§6d/V-IMMUTABLE", "refuse")
e("store/sqlite.py", 545, "store.upsert.immutable", "0008/0019/0037", "§6d/V-IMMUTABLE", "refuse")
e("store/sqlite.py", 558, "store.upsert.immutable", "0008/0019/0037", "§6d/V-IMMUTABLE", "refuse")
e("store/sqlite.py", 564, "store.upsert.immutable", "0008/0019/0037", "§6d/V-IMMUTABLE", "refuse")
e("store/sqlite.py", 573, "store.upsert.immutable", "0008/0019/0037", "§6d/V-IMMUTABLE", "refuse")
e("store/sqlite.py", 590, "store.upsert.immutable", "0008/0019/0037", "§6d/V-IMMUTABLE", "refuse")
e("store/sqlite.py", 600, "store.upsert.immutable", "0008/0019/0037", "§6d/V-IMMUTABLE", "refuse")
e("store/sqlite.py", 498, "store.upsert.marker-introduced", "0041", "§4b INV-11's mirror", "refuse")
e("store/sqlite.py", 516, "store.upsert.relation-only-quarantine", "0041", "§4h(i)", "refuse")
