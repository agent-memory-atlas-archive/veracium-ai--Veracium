...
OVERRIDE = {  # (module, line) -> reason class, where the module default is not the truth for that line
    ...
    ("store/sqlite.py", 179): "control-flow", ("store/sqlite.py", 254): "control-flow", ("store/sqlite.py", 307): "control-flow",
    ("store/sqlite.py", 376): "control-flow", ("store/sqlite.py", 458): "control-flow", ("store/sqlite.py", 717): "control-flow",
    ("store/sqlite.py", 736): "control-flow", ("store/sqlite.py", 780): "control-flow", ("store/sqlite.py", 845): "control-flow",
    ("store/sqlite.py", 861): "predicate-helper", ("store/sqlite.py", 1016): "control-flow", ("store/sqlite.py", 2002): "control-flow",
    ("store/sqlite.py", 2096): "control-flow", ("store/sqlite.py", 2105): "predicate-helper", ("store/sqlite.py", 161): "argument-check",
    ("store/sqlite.py", 355): "argument-check", ("store/sqlite.py", 2167): "argument-check", ("store/sqlite.py", 2711): "argument-check",
    ("store/sqlite.py", 2726): "argument-check", ("store/sqlite.py", 350): "control-flow", ("store/sqlite.py", 729): "control-flow",
    ("store/sqlite.py", 1296): "control-flow", ("store/sqlite.py", 1572): "control-flow", ("store/sqlite.py", 1584): "control-flow",
    ("store/sqlite.py", 1599): "control-flow", ("store/sqlite.py", 2379): "control-flow", ("store/sqlite.py", 2401): "control-flow",
    ("store/sqlite.py", 2729): "control-flow", ("store/sqlite.py", 2144): "argument-check",
...
e("store/sqlite.py", 1637, "store.add-episode", "0009/0010", "X21", "refuse")
e("store/sqlite.py", 1649, "store.add-episode", "0009/0010", "X21", "refuse")
e("store/sqlite.py", 1657, "store.add-episode", "0009/0010", "X21", "refuse")
e("store/sqlite.py", 1664, "store.add-episode", "0009/0010", "X21", "refuse")
e("store/sqlite.py", 1672, "store.add-episode", "0009/0010", "X21", "refuse")
e("store/sqlite.py", 708, "store.confirm.correlation", "0008", "C9", "refuse")
e("store/sqlite.py", 641, "store.confirm.not-assertable", "0008", "§6d", "refuse")
e("store/sqlite.py", 654, "store.confirm.request-digest", "0008", "C9", "refuse")
e("store/sqlite.py", 636, "store.confirm.unknown-edge", "0008", "§6d", "refuse")
e("store/sqlite.py", 1489, "store.consolidation-contribution", "0014", "§2c", "refuse")
e("store/sqlite.py", 1497, "store.consolidation-contribution", "0014", "§2c", "refuse")
e("store/sqlite.py", 1530, "store.consolidation-contribution", "0014", "§2c", "refuse")
e("store/sqlite.py", 2372, "store.consolidation.abandon-live-lease", "0010", "X7", "refuse")
e("store/sqlite.py", 2185, "store.consolidation.contended", "0010", "X7/X11", "refuse")
e("store/sqlite.py", 2357, "store.consolidation.delete-not-current", "0010", "X21", "refuse")
e("store/sqlite.py", 2217, "store.consolidation.renew-refused", "0010", "X7", "refuse")
e("store/sqlite.py", 2312, "store.consolidation.transition", "0010", "§4b", "refuse")
e("store/sqlite.py", 2317, "store.consolidation.transition", "0010", "§4b", "refuse")
e("store/sqlite.py", 2322, "store.consolidation.transition", "0010", "§4b", "refuse")
e("store/sqlite.py", 2328, "store.consolidation.transition", "0010", "§4b", "refuse")
e("store/sqlite.py", 2337, "store.consolidation.transition", "0010", "§4b", "refuse")
e("store/sqlite.py", 2344, "store.consolidation.transition", "0010", "§4b", "refuse")
e("store/sqlite.py", 2347, "store.consolidation.transition", "0010", "§4b", "refuse")
e("store/sqlite.py", 2231, "store.consolidation.write-not-current", "0010", "X23", "refuse")
e("store/sqlite.py", 1312, "store.contribution", "0014", "§4b", "refuse")
e("store/sqlite.py", 1316, "store.contribution", "0014", "§4b", "refuse")
e("store/sqlite.py", 1322, "store.contribution", "0014", "§4b", "refuse")
e("store/sqlite.py", 1327, "store.contribution", "0014", "§4b", "refuse")
e("store/sqlite.py", 1136, "store.correction.authorisation", "0011", "§4b", "refuse")
...
e("store/sqlite.py", 1155, "store.correction.authorisation", "0011", "§4b", "refuse")
e("store/sqlite.py", 1161, "store.correction.authorisation", "0011", "§4b", "refuse")
e("store/sqlite.py", 1166, "store.correction.authorisation", "0011", "§4b", "refuse")
e("store/sqlite.py", 1170, "store.correction.authorisation", "0011", "§4b", "refuse")
e("store/sqlite.py", 1732, "store.delete-episode.outcome", "0009", "§4c", "refuse")
e("store/sqlite.py", 1740, "store.delete-episode.reserved", "0010", "X21", "refuse")
e("store/sqlite.py", 894, "store.edges.read-fence", "0001", "§4", "withhold")
e("store/sqlite.py", 2751, "store.embedding.delayed-writer", "0027", "§4f", "refuse")
e("store/sqlite.py", 2758, "store.embedding.stale-content", "0027", "§4f", "refuse")
e("store/sqlite.py", 1629, "store.episode.attested-redaction", "0041", "§4b-ii INV-11", "refuse")
e("store/sqlite.py", 1622, "store.episode.kind-not-recognised", "0041", "§2d-iv/§4h(ii) write path", "refuse")
e("store/sqlite.py", 1617, "store.episode.marker-introduced", "0041", "§4b INV-11's mirror", "refuse")
e("store/sqlite.py", 2390, "store.export.non-quiescent", "0010", "X-quiesce", "refuse")
e("store/sqlite.py", 1407, "store.flattening", "0021", "§4a", "refuse")
e("store/sqlite.py", 1416, "store.flattening", "0021", "§4a", "refuse")
e("store/sqlite.py", 1425, "store.flattening", "0021", "§4a", "refuse")
e("store/sqlite.py", 1430, "store.flattening", "0021", "§4a", "refuse")
e("store/sqlite.py", 1453, "store.flattening", "0021", "§4a", "refuse")
e("store/sqlite.py", 1845, "store.import-plan", "0009", "§4c", "refuse")
e("store/sqlite.py", 1850, "store.import-plan", "0009", "§4c", "refuse")
e("store/sqlite.py", 1854, "store.import-plan", "0009", "§4c", "refuse")
e("store/sqlite.py", 1860, "store.import-plan", "0009", "§4c", "refuse")
e("store/sqlite.py", 1867, "store.import-plan", "0009", "§4c", "refuse")
e("store/sqlite.py", 1874, "store.import-plan", "0009", "§4c", "refuse")
e("store/sqlite.py", 1889, "store.import-plan", "0009", "§4c", "refuse")
e("store/sqlite.py", 1892, "store.import-plan", "0009", "§4c", "refuse")
e("store/sqlite.py", 1895, "store.import-plan", "0009", "§4c", "refuse")
e("store/sqlite.py", 1898, "store.import-plan", "0009", "§4c", "refuse")
e("store/sqlite.py", 1902, "store.import-plan", "0009", "§4c", "refuse")
e("store/sqlite.py", 1906, "store.import-plan", "0009", "§4c", "refuse")
e("store/sqlite.py", 1951, "store.import-plan", "0009", "§4c", "refuse")
e("store/sqlite.py", 1982, "store.import.attested-redaction", "0041", "§4b-ii INV-11 at the import boundary (§4g)", "refuse")
e("store/sqlite.py", 2008, "store.import.attested-redaction", "0041", "§4b-ii INV-11 at the import boundary (§4g)", "refuse")
e("store/sqlite.py", 2002, "store.import.episode-kind-not-recognised", "0041", "§2d-iv/§4h(ii) import boundary", "refuse")
e("store/sqlite.py", 368, "store.journal.pre-epoch", "0029", "§4a", "refuse")
e("store/sqlite.py", 313, "store.journal.reason-not-dispositioned", "0030", "V-TOTAL", "refuse")
e("store/sqlite.py", 321, "store.journal.redaction-reason", "0041", "§4c/§11.2 D1", "refuse")
...
e("store/sqlite.py", 1786, "store.outcome.context-ref", "0009", "§4c", "refuse")
e("store/sqlite.py", 1719, "store.read.input-claimed", "0010", "§4b", "withhold")
e("store/sqlite.py", 1716, "store.read.output-not-visible", "0010", "§4b", "withhold")
e("store/sqlite.py", 2582, "store.redact.disposition-changed", "0041", "§4h(i)", "refuse")
e("store/sqlite.py", 2539, "store.redact.input-claimed", "0041/0010", "X21", "refuse")
e("store/sqlite.py", 2520, "store.redact.reason-not-registered", "0041", "§11.2", "refuse")
e("store/sqlite.py", 2516, "store.redact.target", "0041", "§4a/INV-5", "refuse")
e("store/sqlite.py", 2531, "store.redact.target", "0041", "§4a/INV-5", "refuse")
...
e("store/sqlite.py", 1070, "store.supersession.integrity", "0014", "§4b", "refuse")
e("store/sqlite.py", 1088, "store.supersession.integrity", "0014", "§4b", "refuse")
e("store/sqlite.py", 1104, "store.supersession.integrity", "0014", "§4b", "refuse")
e("store/sqlite.py", 1109, "store.supersession.integrity", "0014", "§4b", "refuse")
e("store/sqlite.py", 1187, "store.supersession.plan", "0014/0019", "§4b", "refuse")
e("store/sqlite.py", 1209, "store.supersession.plan", "0014/0019", "§4b", "refuse")
e("store/sqlite.py", 1217, "store.supersession.plan", "0014/0019", "§4b", "refuse")
e("store/sqlite.py", 1236, "store.supersession.plan", "0014/0019", "§4b", "refuse")
e("store/sqlite.py", 1241, "store.supersession.plan", "0014/0019", "§4b", "refuse")
e("store/sqlite.py", 245, "store.txn.locked", "0013", "§5b", "refuse")
e("store/sqlite.py", 270, "store.txn.locked-retry", "0013", "§5b", "refuse")
e("store/sqlite.py", 506, "store.upsert.attested-redaction", "0041", "§4b-ii INV-11", "refuse")
e("store/sqlite.py", 528, "store.upsert.immutable", "0008/0019/0037", "§6d/V-IMMUTABLE", "refuse")
e("store/sqlite.py", 534, "store.upsert.immutable", "0008/0019/0037", "§6d/V-IMMUTABLE", "refuse")
e("store/sqlite.py", 544, "store.upsert.immutable", "0008/0019/0037", "§6d/V-IMMUTABLE", "refuse")
e("store/sqlite.py", 557, "store.upsert.immutable", "0008/0019/0037", "§6d/V-IMMUTABLE", "refuse")
e("store/sqlite.py", 563, "store.upsert.immutable", "0008/0019/0037", "§6d/V-IMMUTABLE", "refuse")
e("store/sqlite.py", 572, "store.upsert.immutable", "0008/0019/0037", "§6d/V-IMMUTABLE", "refuse")
e("store/sqlite.py", 589, "store.upsert.immutable", "0008/0019/0037", "§6d/V-IMMUTABLE", "refuse")
e("store/sqlite.py", 599, "store.upsert.immutable", "0008/0019/0037", "§6d/V-IMMUTABLE", "refuse")
e("store/sqlite.py", 497, "store.upsert.marker-introduced", "0041", "§4b INV-11's mirror", "refuse")
e("store/sqlite.py", 515, "store.upsert.relation-only-quarantine", "0041", "§4h(i)", "refuse")
