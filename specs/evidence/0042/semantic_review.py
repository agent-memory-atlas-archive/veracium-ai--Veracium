...
OVERRIDE = {  # (module, line) -> reason class, where the module default is not the truth for that line
    ...
    ("__init__.py", 1795): "control-flow", ("__init__.py", 2079): "internal-invariant", ("__init__.py", 2128): "control-flow",
    ...
    ("store/sqlite.py", 163): "control-flow", ("store/sqlite.py", 238): "control-flow", ("store/sqlite.py", 289): "control-flow",
    ("store/sqlite.py", 350): "control-flow", ("store/sqlite.py", 432): "control-flow", ("store/sqlite.py", 682): "control-flow",
    ("store/sqlite.py", 701): "control-flow", ("store/sqlite.py", 745): "control-flow", ("store/sqlite.py", 810): "control-flow",
    ("store/sqlite.py", 826): "predicate-helper", ("store/sqlite.py", 981): "control-flow", ("store/sqlite.py", 1922): "control-flow",
    ("store/sqlite.py", 1971): "control-flow", ("store/sqlite.py", 1980): "predicate-helper", ("store/sqlite.py", 145): "argument-check",
    ("store/sqlite.py", 329): "argument-check", ("store/sqlite.py", 2042): "argument-check", ("store/sqlite.py", 2320): "argument-check",
    ("store/sqlite.py", 2335): "argument-check", ("store/sqlite.py", 324): "control-flow", ("store/sqlite.py", 694): "control-flow",
    ("store/sqlite.py", 1261): "control-flow", ("store/sqlite.py", 1537): "control-flow", ("store/sqlite.py", 1549): "control-flow",
    ("store/sqlite.py", 1564): "control-flow", ("store/sqlite.py", 2254): "control-flow", ("store/sqlite.py", 2276): "control-flow",
    ("store/sqlite.py", 2338): "control-flow", ("store/sqlite.py", 2019): "argument-check",
...
e("store/sqlite.py", 1596, "store.add-episode", "0009/0010", "X21", "refuse")
e("store/sqlite.py", 1608, "store.add-episode", "0009/0010", "X21", "refuse")
e("store/sqlite.py", 1616, "store.add-episode", "0009/0010", "X21", "refuse")
e("store/sqlite.py", 1623, "store.add-episode", "0009/0010", "X21", "refuse")
e("store/sqlite.py", 1631, "store.add-episode", "0009/0010", "X21", "refuse")
e("store/sqlite.py", 673, "store.confirm.correlation", "0008", "C9", "refuse")
e("store/sqlite.py", 606, "store.confirm.not-assertable", "0008", "§6d", "refuse")
e("store/sqlite.py", 619, "store.confirm.request-digest", "0008", "C9", "refuse")
e("store/sqlite.py", 601, "store.confirm.unknown-edge", "0008", "§6d", "refuse")
e("store/sqlite.py", 1454, "store.consolidation-contribution", "0014", "§2c", "refuse")
e("store/sqlite.py", 1462, "store.consolidation-contribution", "0014", "§2c", "refuse")
e("store/sqlite.py", 1495, "store.consolidation-contribution", "0014", "§2c", "refuse")
e("store/sqlite.py", 2247, "store.consolidation.abandon-live-lease", "0010", "X7", "refuse")
e("store/sqlite.py", 2060, "store.consolidation.contended", "0010", "X7/X11", "refuse")
e("store/sqlite.py", 2232, "store.consolidation.delete-not-current", "0010", "X21", "refuse")
e("store/sqlite.py", 2092, "store.consolidation.renew-refused", "0010", "X7", "refuse")
e("store/sqlite.py", 2187, "store.consolidation.transition", "0010", "§4b", "refuse")
e("store/sqlite.py", 2192, "store.consolidation.transition", "0010", "§4b", "refuse")
e("store/sqlite.py", 2197, "store.consolidation.transition", "0010", "§4b", "refuse")
e("store/sqlite.py", 2203, "store.consolidation.transition", "0010", "§4b", "refuse")
e("store/sqlite.py", 2212, "store.consolidation.transition", "0010", "§4b", "refuse")
e("store/sqlite.py", 2219, "store.consolidation.transition", "0010", "§4b", "refuse")
e("store/sqlite.py", 2222, "store.consolidation.transition", "0010", "§4b", "refuse")
e("store/sqlite.py", 2106, "store.consolidation.write-not-current", "0010", "X23", "refuse")
e("store/sqlite.py", 1277, "store.contribution", "0014", "§4b", "refuse")
e("store/sqlite.py", 1281, "store.contribution", "0014", "§4b", "refuse")
e("store/sqlite.py", 1287, "store.contribution", "0014", "§4b", "refuse")
e("store/sqlite.py", 1292, "store.contribution", "0014", "§4b", "refuse")
e("store/sqlite.py", 1101, "store.correction.authorisation", "0011", "§4b", "refuse")
e("store/sqlite.py", 1108, "store.correction.authorisation", "0011", "§4b", "refuse")
e("store/sqlite.py", 1112, "store.correction.authorisation", "0011", "§4b", "refuse")
e("store/sqlite.py", 1116, "store.correction.authorisation", "0011", "§4b", "refuse")
e("store/sqlite.py", 1120, "store.correction.authorisation", "0011", "§4b", "refuse")
e("store/sqlite.py", 1126, "store.correction.authorisation", "0011", "§4b", "refuse")
e("store/sqlite.py", 1131, "store.correction.authorisation", "0011", "§4b", "refuse")
e("store/sqlite.py", 1135, "store.correction.authorisation", "0011", "§4b", "refuse")
e("store/sqlite.py", 1691, "store.delete-episode.outcome", "0009", "§4c", "refuse")
e("store/sqlite.py", 1699, "store.delete-episode.reserved", "0010", "X21", "refuse")
e("store/sqlite.py", 859, "store.edges.read-fence", "0001", "§4", "withhold")
e("store/sqlite.py", 2360, "store.embedding.delayed-writer", "0027", "§4f", "refuse")
e("store/sqlite.py", 2367, "store.embedding.stale-content", "0027", "§4f", "refuse")
e("store/sqlite.py", 1587, "store.episode.kind-not-recognised", "0041", "§2d-iv/§4h(ii) write path", "refuse")
e("store/sqlite.py", 1582, "store.episode.marker-introduced", "0041", "§4b INV-11's mirror", "refuse")
e("store/sqlite.py", 2265, "store.export.non-quiescent", "0010", "X-quiesce", "refuse")
e("store/sqlite.py", 1372, "store.flattening", "0021", "§4a", "refuse")
e("store/sqlite.py", 1381, "store.flattening", "0021", "§4a", "refuse")
e("store/sqlite.py", 1390, "store.flattening", "0021", "§4a", "refuse")
e("store/sqlite.py", 1395, "store.flattening", "0021", "§4a", "refuse")
e("store/sqlite.py", 1418, "store.flattening", "0021", "§4a", "refuse")
e("store/sqlite.py", 1804, "store.import-plan", "0009", "§4c", "refuse")
e("store/sqlite.py", 1809, "store.import-plan", "0009", "§4c", "refuse")
e("store/sqlite.py", 1813, "store.import-plan", "0009", "§4c", "refuse")
e("store/sqlite.py", 1819, "store.import-plan", "0009", "§4c", "refuse")
e("store/sqlite.py", 1826, "store.import-plan", "0009", "§4c", "refuse")
e("store/sqlite.py", 1833, "store.import-plan", "0009", "§4c", "refuse")
e("store/sqlite.py", 1881, "store.import-plan", "0009", "§4c", "refuse")
e("store/sqlite.py", 1922, "store.import.episode-kind-not-recognised", "0041", "§2d-iv/§4h(ii) import boundary", "refuse")
e("store/sqlite.py", 342, "store.journal.pre-epoch", "0029", "§4a", "refuse")
e("store/sqlite.py", 295, "store.journal.reason-not-dispositioned", "0030", "V-TOTAL", "refuse")
...
e("store/sqlite.py", 1745, "store.outcome.context-ref", "0009", "§4c", "refuse")
e("store/sqlite.py", 1678, "store.read.input-claimed", "0010", "§4b", "withhold")
e("store/sqlite.py", 1675, "store.read.output-not-visible", "0010", "§4b", "withhold")
...
e("store/sqlite.py", 1035, "store.supersession.integrity", "0014", "§4b", "refuse")
e("store/sqlite.py", 1053, "store.supersession.integrity", "0014", "§4b", "refuse")
e("store/sqlite.py", 1069, "store.supersession.integrity", "0014", "§4b", "refuse")
e("store/sqlite.py", 1074, "store.supersession.integrity", "0014", "§4b", "refuse")
e("store/sqlite.py", 1152, "store.supersession.plan", "0014/0019", "§4b", "refuse")
e("store/sqlite.py", 1174, "store.supersession.plan", "0014/0019", "§4b", "refuse")
e("store/sqlite.py", 1182, "store.supersession.plan", "0014/0019", "§4b", "refuse")
e("store/sqlite.py", 1201, "store.supersession.plan", "0014/0019", "§4b", "refuse")
e("store/sqlite.py", 1206, "store.supersession.plan", "0014/0019", "§4b", "refuse")
e("store/sqlite.py", 229, "store.txn.locked", "0013", "§5b", "refuse")
e("store/sqlite.py", 254, "store.txn.locked-retry", "0013", "§5b", "refuse")
e("store/sqlite.py", 493, "store.upsert.immutable", "0008/0019/0037", "§6d/V-IMMUTABLE", "refuse")
e("store/sqlite.py", 499, "store.upsert.immutable", "0008/0019/0037", "§6d/V-IMMUTABLE", "refuse")
e("store/sqlite.py", 509, "store.upsert.immutable", "0008/0019/0037", "§6d/V-IMMUTABLE", "refuse")
e("store/sqlite.py", 522, "store.upsert.immutable", "0008/0019/0037", "§6d/V-IMMUTABLE", "refuse")
e("store/sqlite.py", 528, "store.upsert.immutable", "0008/0019/0037", "§6d/V-IMMUTABLE", "refuse")
e("store/sqlite.py", 537, "store.upsert.immutable", "0008/0019/0037", "§6d/V-IMMUTABLE", "refuse")
e("store/sqlite.py", 554, "store.upsert.immutable", "0008/0019/0037", "§6d/V-IMMUTABLE", "refuse")
e("store/sqlite.py", 564, "store.upsert.immutable", "0008/0019/0037", "§6d/V-IMMUTABLE", "refuse")
e("store/sqlite.py", 471, "store.upsert.marker-introduced", "0041", "§4b INV-11's mirror", "refuse")
e("store/sqlite.py", 480, "store.upsert.relation-only-quarantine", "0041", "§4h(i)", "refuse")
