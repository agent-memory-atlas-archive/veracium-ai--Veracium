...
#: ...)` reads were rewritten to plain access rather than tabled; the
...
#: module-plain 312 -> 310, the rest unchanged; 0037 v23 / 0006 v10 (2026-09-14:
...
#: 0037 v24.1 (2026-09-14: the fail-closed boundary rule — the abbreviation list
...
#: unchanged; 0037 v24.3 (2026-09-14: `enclosure_structure`'s reads and the
#: lineage helper's `.provenance.producer` on existing records) moved
#: dotted/dataflow 5,889 -> 5,893, the rest unchanged; 0027 v14 (2026-09-14:
...
#: the 0018 ladder diagnostic (2026-09-18: `_release_heads` reads the shipped
#: release record — `sv.RELEASES.read_text`, `json.loads`, `r.get`,
#: `out.setdefault`, `heads[v]` — and the derived `_ladder_diagnostic`) moved
#: dotted/dataflow 5,941 -> 5,950 and module-plain 314 -> 315, the rest unchanged.
...
#: 0041 tranche 2 (schema 14 -> 15: schema_version, migration, sqlite, doctor): moved dotted/dataflow 6,471 -> 6,485, dotted/module-plain 323 -> 325, the rest unchanged.
#: 0041 tranche 3 (redact: sqlite, schema, base, why, redaction): moved dotted/dataflow 6,485 -> 6,643, dotted/module-plain 325 -> 336, the rest unchanged.
#: 0041 tranche 3 (redact: sqlite, schema, base, why, redaction, combining): moved nothing, the rest unchanged.
#: 0041 tranche 3 (redact; the disposition reads made explicit, the combining registry row): moved nothing, the rest unchanged.
#: 0041 tranche 3 (the base refusal without a dunder): moved dotted/dataflow 6,643 -> 6,642, the rest unchanged.
SRC_ATTRIBUTE_PARTITION = {
    "dotted/dataflow": 6642,
    "dotted/module-machinery": 19,
    "dotted/module-plain": 336,
    "dotted/module-protected": 48,
    "getattr/dataflow": 33,
}
SRC_ATTRIBUTE_TOTAL = 7078
