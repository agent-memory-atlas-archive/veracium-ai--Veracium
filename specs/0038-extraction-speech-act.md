...
with directive, second-person and sentence-boundary refusals, and the gloss DERIVED
from the span — the model's summary discarded, nothing to ground) — keyed on the relation's
