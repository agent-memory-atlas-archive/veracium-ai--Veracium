...
def _mktemp_under_tmp_path(tmp_path):
    ...
    2026-09-16: `tempfile.mktemp(suffix=".db")` at 1 site in this file wrote
...
def test_s7_export_format_version_is_independent():
    ...
    assert FORMAT_VERSION == 12     # specs/0026 bumped 9->10, 0037 10->11, 0037 v23 11->12, all conditional
